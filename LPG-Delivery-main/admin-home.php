...
<body>
    <div class="nav" style="background-color: #212529; padding: 1rem 2rem;">
        ...
        <div class="right-links">
            ...
            ?>
            <a href="purchase-history.php"> <button class="btn">Purchase History</button> </a>
...
// Add record here...
    ...
    $insert_query = "INSERT INTO `orders` (`Fullname`, 
    `Contact`, `Addresss`, `Quantity`)

    VALUES ('$Fullname', '$Contact', '$Addresss', '$Quantity') 
    ";
